...
" description   based on Rams with colors from An Old Hope
"
" colors
" foreground = #262b31 
" background = #ebebeb
...
hi LineNr guifg=#262b31 guibg=#F0F0F0 gui=NONE cterm=NONE
...
hi Pmenu guifg=white guibg=#787878 gui=NONE cterm=NONE
...
hi SpellCap guifg=#262b31 guibg=#ebebeb gui=underline cterm=NONE
...
hi Title guifg=#262b31 guibg=#ebebeb gui=bold cterm=NONE
hi VertSplit guifg=#262b31 guibg=#ebebeb gui=NONE cterm=NONE
hi Visual guifg=#50B4D8 guibg=#ebebeb gui=reverse cterm=reverse
